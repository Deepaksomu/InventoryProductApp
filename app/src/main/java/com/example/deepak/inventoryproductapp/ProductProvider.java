...
import com.example.deepak.inventoryproductapp.data.DbHelper;

public class ProductProvider extends ContentProvider {
    public static final String CONTENT_AUTHORITY = " com.example.deepak.inventoryproductapp";
    ...
    /** The {@link DbHelper} which helps the app create, version, access the SQLite database */
